      ...
      <div className="flex w-full max-w-4xl shadow-lg">
        ...
        <div className="hidden md:block w-full max-w-md">
          ...
          >
            ...
            <circle cx="200" cy="200" r="150" fill="#3b82f6" fillOpacity="0.1" />
            <circle cx="200" cy="200" r="100" fill="#3b82f6" fillOpacity="0.2" />
            <circle cx="200" cy="200" r="50" fill="#3b82f6" fillOpacity="0.3" />
          </svg>
        </div>
      </div>
    </div>
